...
final class StreamedResponse extends Response implements StreamedResponseInterface
{
    ...
    /**
     * @param Closure(callable(string): bool): void $producer Emits body chunks through the writer it is
     *                                                        handed; the writer returns false once the client has disconnected.
